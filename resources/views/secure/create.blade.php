...
@endsection
@section('boton')
<a class="nav-link nav-link-icon" href="/secure/login">
      ...
      <div class="col-lg-6 col-md-8">
        <div class="card bg-secondary shadow border-0">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            ...
            <form role="form" action="/secure/store">
              ...
              <div class="row my-4">
                <div class="col-12">
                  <div class="custom-control custom-control-alternative custom-checkbox">
                    <input class="custom-control-input" name="checkpp" id="customCheckRegister" type="checkbox">
